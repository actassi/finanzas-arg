...
export default function TransactionsTableClient(props: {
  ...
  return (
    <div className="rounded-lg border border-slate-800 overflow-x-auto">
      {/* min-w fuerza scroll horizontal real */}
      <table className="min-w-[1400px] w-full text-sm">
        <thead className="bg-slate-900">
          <tr className="text-left text-slate-300">
            <th className="px-3 py-2 whitespace-nowrap">Fecha</th>
            <th className="px-3 py-2 whitespace-nowrap">Cuenta</th>
            <th className="px-3 py-2 whitespace-nowrap">Merchant</th>
            <th className="px-3 py-2">Descripción</th>
            <th className="px-3 py-2 whitespace-nowrap">Categoría</th>
            <th className="px-3 py-2 text-right whitespace-nowrap">Monto</th>
            <th className="px-3 py-2 whitespace-nowrap">Comprobante</th>
            <th className="px-3 py-2 whitespace-nowrap">Cuota</th>
        ...
        <tbody className="divide-y divide-slate-800">
          {rows.map((r) => {
            ...
            const d =
              drafts[r.id] ?? { merchant_name: r.merchant_name ?? "", category_id: r.category_id ?? "", applyToSimilar: true };
            ...
            return (
              <tr key={r.id} className="hover:bg-slate-900/60">
                ...
                <td className="px-3 py-2 sticky right-0 bg-slate-950 border-l border-slate-800 align-top">
